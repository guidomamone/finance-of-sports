# Fuentes — Arabia Saudita

Detalle línea-por-club del sourcing de Arabia Saudita. El detalle completo de cada club
(links, qué se probó, qué falta) está en el archivo que linkea cada línea,
`fuentes/Arabia Saudita/<Club>.md`. El índice de países, y las reglas de formato y de
...
busque. NO es una conclusión verificada con la metodología del proyecto (REGLA 2 de `fuentes/README.md`) —
