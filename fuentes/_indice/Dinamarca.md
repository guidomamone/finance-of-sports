...
Detalle línea-por-club del sourcing de Dinamarca. El detalle completo de cada club
(links, qué se probó, qué falta) está en el archivo que linkea cada línea,
`fuentes/Dinamarca/<Club>.md`. El índice de países, y las reglas de formato y de
...
- [Randers FC](<../Dinamarca/Randers FC.md>) — 30 ejercicios reales, serie completa 1995-2025, sin cargar aún — Último chequeo: 2026-09-17
- [Silkeborg IF](<../Dinamarca/Silkeborg IF.md>) — 24 ejercicios reales, serie completa 2002-2025, sin cargar aún — Último chequeo: 2026-09-17
- [SønderjyskE](<../Dinamarca/SønderjyskE.md>) — 17 ejercicios reales, serie completa 2008/09-2024/25, sin cargar aún — Último chequeo: 2026-09-17
