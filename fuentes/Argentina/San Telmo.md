...
- Sin PDFs oficiales encontrados. Sitio oficial: clubsantelmo.com.ar (con un "Departamento de
  Socios" real, sin balance/memoria linkeado). También existe soydetelmo.com.ar, con contenido
  institucional/histórico similar — no quedó claro cuál es el dominio "primario", ninguno de los
  dos publica el balance.
