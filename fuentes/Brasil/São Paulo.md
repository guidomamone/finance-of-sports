# São Paulo FC (São Paulo Futebol Clube — sociedade civil sem fins econômicos, no es SAF)

- **Hallazgo notable de la sesión 2026-09-16**: São Paulo FC tiene, en `saopaulofc.net`, una página
  de transparencia (`saopaulofc.net/institucional/transparencia/`) que linkea a un CDN propio
  (`cdn.saopaulofc.net`) con balanços que retroceden hasta **2006** (2006-2023 completo, con
  documentos partidos en "Parte 1/2/3" para los años más viejos por tamaño de escaneo). Solo se
  descargó la parte más reciente y relevante para el sitio (2018 en adelante); queda pendiente un
  archivo histórico enorme (2006-2017) sin bajar, documentado acá para una sesión futura que quiera
  la serie completa.
- **5 ejercicios descargados a `Clubes/Brasil/São Paulo/`, todos vía la fuente oficial
  (cdn.saopaulofc.net), serie continua 2018-2024:**
  - `demonstracoes-financeiras-2018-2019.pdf` — cubre AMBOS ejercicios 2019 y 2018 en un solo
    documento (`demonstracoes-financeiras2019-2018.pdf` en el CDN propio).
  - `demonstracoes-financeiras-2020-2021.pdf` — exercício 2021 e 2020 (`balanco2021.pdf`; mismo
    archivo, confirmado por tamaño idéntico 147.986 bytes, que el mirror de la federación en
    `Institucional/2021/SaoPauloFC-2022-10aRev.pdf`).
  - `demonstracoes-financeiras-2021-2022.pdf` — exercício 2022 e 2021
    (`balanco-2022_demonstracoes-financeiras-e-relatorio-dos-auditores.pdf`). Formato "publicación
    legal" (layout de diario O Estado de S. Paulo).
  - `demonstracoes-financeiras-2022-2023.pdf` — exercício 2023 e 2022 (`balanco-financeiro-2023.pdf`;
    mismo archivo, confirmado por tamaño idéntico 6.486.733 bytes, que un PDF ya indexado en el
    repositorio de la federación bajo un nombre de protocolo interno confuso,
    `Institucional/2023/1402169_BALANÇOSPFC_2018_2.pdf` — OJO: ese nombre de archivo dice "2018"
    pero el contenido real es el ejercicio 2023/2022; es un número de protocolo/radicado, no el año
    fiscal. No confundir en una sesión futura.
  - `demonstracoes-financeiras-2023-2024.pdf` — exercício 2024 e 2023, vía repositorio de la
    federación (`Institucional/2024/São Paulo.pdf`) — no se encontró todavía el mirror directo en
    `cdn.saopaulofc.net` para este año (el CDN parece no haberse actualizado más allá de 2023 al
    momento de esta sesión).
- **Falta 2020 standalone** (solo se tiene como comparativo dentro del documento 2021).
- Pendiente grande para una sesión futura con foco en histórico largo: 2006-2017 en
  `cdn.saopaulofc.net/2022/09/balanco<año>[a/b/c].pdf` (mismo patrón de URL, confirmado que existen
  para 2006 a 2017 inclusive, con partes A/B/C para los años más viejos).
- Contacto: `saopaulofc.net/institucional/transparencia/`;
